        ...
        <div className="col-span-2 xl:col-span-2" key={index}>
          <div className="card-person">
            <div className="card-person__thumbnail">
              ...
              />
              <div
                className={`card-person__layer ${
                  cardData.activeLayer ? "card-person__layer--active" : ""
                }`}
              ></div>
            </div>
            ...
            <div
              className={`card-person__contact ${
                cardData.activeContact ? "card-person__contact--active" : ""
              }`}
            >
              <a href="">
